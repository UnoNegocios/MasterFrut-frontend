        ...
        <v-menu v-model="selectedOpen" :close-on-content-click="false" :activator="selectedElement" offset-x >
          <v-card flat width="400px">
            ...
            <v-card-actions>
              ...
              <v-spacer></v-spacer>
              <v-btn @click="status(selectedEvent.id, selectedEvent.client.id)" elevation="0" v-if="!selectedEvent.completed" style="text-transform:capitalize; letter-spacing:0;" class="px-5 mb-2 mr-2" color="primary">Terminar</v-btn>
            </v-card-actions>
          </v-card>
        </v-menu>
      </v-sheet>
